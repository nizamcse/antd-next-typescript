...
const ExpenseCalc: React.FC = () => {
    const initialValue = {description: "", amount: 0}
    ...
    return (
        ...
        <div style={{padding: "20px"}}>
            ...
            <Form form={form} initialValues={initialValue} onFinish={handleAddExpense} layout="inline" style={{marginBottom: "20px"}}>
                <Form.Item
                    name="description"
                    label="Description"
